...
const DataService = {
    ...
    PostWDClusterPair: async function (cluster_id, pageid, currentDoc, summary_title) {
        return await axios.post(BASE_API_URL + "/entitylinks_add/" + cluster_id + '/' + pageid + '/' + currentDoc + '/' + summary_title, { headers: authHeader() });
    },
